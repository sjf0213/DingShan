...
/*!
 ...
 @abstract 执行http请求
 */
+ (NSData *)executeHttpRequest:(NSMutableURLRequest *)request response:(NSHTTPURLResponse **)response error:(NSError **)error;
/*!
 @method
...
/*!
 ...
 @abstract 删除持久化内容
 */
+ (void)removeRecoder:(OSSMultipartHelper *)multipart;
/*!
 @method
...
/*!
 @method
 @abstract 当一个任务被取消时，构造一个错误信息返回
 */
+ (NSError *)buildErrorWhenInterrupted;

+ (NSString *)urlencode:(NSString *)origin;
@end
